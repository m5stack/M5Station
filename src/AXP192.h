...
class AXP192 {
   public:
    ...
    enum GroovePort {
        kGroovePort_A1_A2 = 0b00000001,
        kGroovePort_B1    = 0b00000010,
        kGroovePort_B2    = 0b00000100,
        kGroovePort_C1    = 0b00001000,
        kGroovePort_C2    = 0b00010000,
        kGroovePort_ALL   = 0b00011111,
        kGroovePort_MAX,
    };
    ...
    void SetGPIOOutput(uint8_t bitfield);
    uint8_t GetGPIOOutput();
    void SetGroovePower(uint8_t mask, GroovePower state);
