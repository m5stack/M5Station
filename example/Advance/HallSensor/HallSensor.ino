...
#define HORIZONTAL_RESOLUTION 240  //屏幕水平分辨率
#define VERTICAL_RESOLUTION   135  //屏幕竖直分辨率
...
void showSignal() {
    ...
    for (n = 0; n < HORIZONTAL_RESOLUTION;
        ...
        // Within the horizontal resolution, each pixel is drawn according to
        // the calculated magnetic force
        x = n;
        float value =
